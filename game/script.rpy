...
label read_slide:
    ...
    "Still nothing."
    "'What the hell?'"
    "You try to highlight the text."
    "Nothing."
    "You drag your mouse across the sentence."
    "Nothing highlights."
    "You click somewhere else on the slide."
    "The cursor moves normally."
    "You click back on the sentence."
    "Nothing."
    "You stare at it."
    "'Okay...'"
    "You open the slide's formatting menu."
    "Everything looks around."
    "Font."
    "Size."
    "Color."
    "Spacing."
    "You check the text box."
    "There isn't one."
    "You freeze."
    "You look at the sentence again."
    "There's no text box."
    "There's no shape."
    "There's nothing."
    "The words are simply there."
    "'That's not possible.'"
    "You close the formatting menu."
    "You click onto slide 12."
    "Everything is normal."
    "You click back."
    "Slide 13 of 12."
    "Don't let it reach 3."
    ...
    "You blink."
    "The sentence is still the same."
    "You blink again."
    "Still the same."
    "'I'm seeing things.'"
    "You lean back."
    ...
    "You stop."
    "You stare at the screen."
    "The slide now says exactly what you were thinking."
    "You slowly move your mouse."
    ...
    "Nothing."
    "You look at the presentation."
    "A new line has appeared underneath the warning."
    "You already called."
    "Your stomach drops."
    "'What?'"
    "You look at your phone."
    "The call history is open."
    "You don't remember opening it."
    "There is one outgoing call."
    "You stare at the number."
    "It's the same number that called you."
    "You never called it."
    "You look back at the presentation."
    "The second line is gone."
    "Only the warning remains."
    "Don't let it reach 3:00."
    "You stare at it."
    ...
    menu:
        "Check the call history":
            jump check_call_history
        "Try to inspect the slide again"
            jump inspect_slide
        "Close the presentation":
            jump close_presentation
        "Wait until 2:50":
...
label check_call_history:
    "You pick up your phone."
    "You open your recent calls."
    "You scroll through the list."
    "Your call history looks normal."
    "A few spam calls."
    "A call from Mom."
    "A couple of missed calls from your friends."
    "Then you see it."
    "Unknown Number."
    "2:46 AM."
    "Incoming."
    ...
    "It couldn't have lasted eleven seconds."
    "You barely had time to say anything."
    "You check the timestamp again."
    "2:47 AM."
    "You glance at the clock."
    "2:49 AM."
    "You look back at your phone."
    "The outgoing call is still there."
    "You press your finger against it."
    "Delete."
    "The call disappears."
    "You let out a breath."
    "'Okay.'"
    ...
    "You look at your presentation."
    "Slide 13 of 12."
    "Don't let it reach 3:00."
    "You stare at the warning."
    play sound "notification.ogg"
    ...
    "ANSWER?"
    "You stare at it."
    "Your hand hovers over the screen."
    "The presentation makes a quiet clicking sound."
    "Click."
    "You look at the laptop."
    "Slide 13 hasn't changed."
    "Don't let it reach 3:00."
    "You look back at your phone."
    "ANSWER?"
    ...
    "2:49 AM."
    "Still."
    "You slowly look back at the presentation."
...
label put_phone_away:
    "TBD!"

label inspect_slide:
    "TBD!"

label wait_until_250:
    "TBD!"
